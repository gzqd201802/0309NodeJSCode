...
// ### 获取多条随机笑话
app.get('/api/joke/list', (request, response) => {
    // 接收 get 请求的参数 - get 请求参数就在请求报文中
    console.log('请求报文', request);
    // 从请求报文中获取 get 的请求参数 num 的值
    // 1. request.query   对象格式，接收所有 get 的请求参数
    // 2. { num }         从对象中解构并把对象的 num 进行赋值
...
// 客户端访问的完整地址：   http://127.0.0.1:3000/api/joke/list